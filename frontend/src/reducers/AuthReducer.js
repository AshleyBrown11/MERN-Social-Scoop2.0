// AuthReducer have all Auth related functionality 
// reducers provide a way to update an applications state using an action
// by defining reducers and dispatching actions to the store, I was able to build a powerful, scalable application that will be easy to maintain and update
